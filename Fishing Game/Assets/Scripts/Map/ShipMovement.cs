...
public class ShipMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //Debug.Log(GameManager.shipPosition);
        //Debug.Log(targetObject.transform.position);
        //Debug.Log("start" + onStart);
        //Debug.Log("clear1" + onClear1);
        ...
        else if (onClear1 == true)
        {
            ...
            {
                targetObject.transform.position = new Vector2(635f, 595f);
                onClear1 = false;
            }
        ...
        {
            if (Input.GetKeyDown(KeyCode.RightArrow) && MapGameManager.hasFinishedRain2)
            {
                targetObject.transform.position = new Vector2(1130f, 585f);
                onRain2 = false;
            }
        }
        else if (onRain3 == true)
        {
            // No movement options
        }
        ...
        {
            if (Input.GetKeyDown(KeyCode.UpArrow) && MapGameManager.hasFinishedShop2)
            {
                targetObject.transform.position = new Vector2(1340f, 740f);
                onShop2 = false;
            }
            else if (Input.GetKeyDown(KeyCode.DownArrow) && MapGameManager.hasFinishedShop2)
            {
        ...
        if (targetObject.transform.position != MapGameManager.shipPosition)
        {
            ...
            Debug.Log(MapGameManager.shipPosition);
        }
    }
}
